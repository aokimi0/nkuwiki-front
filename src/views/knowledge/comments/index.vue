<template>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['knowledge:comments:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['knowledge:comments:export']"
        >
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['knowledge:comments:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['knowledge:comments:delete']"
          >
            删除
          </el-button>
        </template>
  ...
  <!-- 表单弹窗：添加/修改 -->
  <CommentsForm ref="formRef" @success="getList" />
</template>
...
const list = ref<CommentsVO[]>([]) // 列表的数据
...
const getList = async () => {
  loading.value = true
  try {
    const data = await CommentsApi.getCommentsPage(queryParams)
...
const handleExport = async () => {
  try {
    ...
    const data = await CommentsApi.exportComments(queryParams)
    download.excel(data, '评论信息.xls')
  } catch {
  } finally {
